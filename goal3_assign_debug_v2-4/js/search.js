...
// Encapsulation - Create privatized scope using a self-executing function
(function(){
	...
	var validqte = function(query){   //Fixed error, replaced double equal with single equal.
		
		// Trim whitespace from start and end of search query
		while(query.charAt(0) == " "){  //Fixed error, changed single equal sign to double equal sign.
		...
		if(query.length < 3){
			alert("Your search query is too small, try again."); //Fixed error, added ending quotations.
